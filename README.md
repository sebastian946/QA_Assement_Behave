...
behave --no-capture --format plain --tags=@regression_tests -Dcountry=co -Dtestrail={testrail_report} -Ddriver=local


## Correcciones

Se realizaron cambios en el enviorement.py el cual habia que cambiar a Chrome ya que se encontraba en minuscula.